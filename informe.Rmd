...
dicc_pie = "Fuente: 'Datos de miércoles', proyecto semanal de datos organizado por la comunidad de R (https://github.com/cienciadedatos/datos-de-miercoles/tree/master/datos/2019/2019-06-12)"
diccionario |>
  gt(rowname_col = "Variable") |>
  tab_options(table.width = "75%") |> 
  tab_stubhead(label = "Variable") |> 
  gt_theme_dark() |> 
  tab_source_note(dicc_pie)
```
...
sample_n(vinos, 4) |>
  ...
  tab_header(
    title = "Reseñas de Vinos",
    subtitle = "muestra de 4 registros") |> 
  tab_source_note(
    source_note = "Fuente: Revista Wine Enthusiast - www.wineenthusiast.com")
```
